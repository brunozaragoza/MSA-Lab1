...
public:
  ...
  virtual std::string toString() const {
    return tfm::format("PointEmitter[\n"
                          " position = %s,\n"
                          " radiance = %s,\n"
                          "]",
                          m_position.toString(), m_radiance.toString());
  }
  ...
  virtual Color3f sample(EmitterQueryRecord &lRec, const Point2f &sample,
  ...
  virtual float pdf(const EmitterQueryRecord &lRec) const { return 1.; }
